...
<div class="card-container border max-h-[77vh]   border-l-secondary-color border-l-[30px]  w-full rounded-md  p-[15px] shadow-2xl cursor-pointer    transition-transform  ease-in-out  delay-75      " >
    <div class="card flex justify-between " id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <div class="card-details mt-4  mb-4 w-2/3 pr-20  max-h-[70vh]  overflow-auto  "  >
